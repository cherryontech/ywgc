...
const LifecycleItem = (props) => {
  return (
    <div className='flex relative bg-white flex-col justify-center items-center px-4 py-8 rounded-3xl text-base'>
      <img className='max-w-none absolute -top-12 hidden md:block' src={props.data.icon} alt={props.data.title} />
      <img className='max-w-none absolute -top-2 md:hidden block' src={props.data.iconMobile} alt={props.data.title} />
