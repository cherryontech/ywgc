...
const Footer = () => {
  return (
    <div className="bg-green-700 text-white text-center py-14 text-base md:text-xl px-6">
      ...
      <p className='text-center text-white'>Icons from &quot;Lawn Care&quot; collection, created by Berkah Icon, from <a className='underline' href='https://thenounproject.com/browse/collection-icon/lawn-care-163681/?p=1'>Noun Project</a> CC BY 3.0</p>
    </div>
  )
}
