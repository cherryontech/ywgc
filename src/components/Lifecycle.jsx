    ...
    <div className="px-4 py-8 flex justify-center items-center flex-col">
      ...
      <ul className='flex flex-col md:flex-row md:my-12 md:mx-10 my-12'>
        <li className='relative md:flex md:flex-col md:ml-28 '>
          ...
          <div>
            <p className='mb-10 px-12 md:my-3 md:px-0'>Get in touch with us! Together we’ll figure out what kind of work you need done and the best date for it to happen.</p>
          </div>
        </li>
        ...
        <li className='relative md:flex md:flex-col'>
          ...
          <div className="md:hidden absolute left-4 w-1 h-full bg-green-800"></div>
          <div>
            <p className='md:ml-0 mb-10 px-12 md:mx-20 md:my-3 md:pl-0 md:pr-10'>We’ll do the work agreed, and provide before and after pictures of the work we do.</p>
          </div>
        </li>
        <li className='relative md:flex md:flex-col'>
          ...
          <div>
            <p className='md:ml-0 mb-10 px-12 mt-2 md:my-3 md:px-0'>We’ll send you the invoice with the agreed-upon amount.</p>
          </div>
        </li>
